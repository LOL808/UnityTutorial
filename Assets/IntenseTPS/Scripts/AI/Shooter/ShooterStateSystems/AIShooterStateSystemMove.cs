...
namespace Shooter.StateSystems
{
    ...
    public class AIShooterStateSystemMove : AIStateSystemMove
    {
        ...
        public override void SetMoveToPosition(AIBrain ai, ET.MoveType moveType, ET.MoveToType moveToType, Vector3 _movePosition, bool usePath = false, UnityEngine.AI.NavMeshPath path = null)
        {
            SetMoveToPosition(ai, moveType, moveToType, usePath, path);
            moveToPosition = _movePosition;
        }

        public override void SetMoveToPositionNStartMove(AIBrain ai, ET.MoveType moveType, ET.MoveToType moveToType, bool usePath = false, UnityEngine.AI.NavMeshPath path = null)
        {
            SetMoveToPosition(ai, moveType, moveToType, usePath, path);
            StartMoving(ai);
        }

        public override void SetMoveToPositionNStartMove(AIBrain ai, ET.MoveType moveType, ET.MoveToType moveToType, Vector3 movePosition, bool usePath = false, UnityEngine.AI.NavMeshPath path = null)
        {
        ...
        {
            UnityEngine.AI.NavMeshAgent agent = ai.Agent;
            if (agent)
            {
